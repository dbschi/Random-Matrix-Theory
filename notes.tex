...
\postdate{}
\date{}
\title{MATH 510 - topics in Analysis: Random Matrix Theory}
\author{Chi Li}
\begin{document}
\maketitle
\tableofcontents
\newcounter{lecture}
This is a set of notes I took in my final quarter in Northwestern University. I am in the process of digitizing this. Feel free to email me for any suggestions.
\forloop{lecture}{1}{\value{lecture}<5}
{
	\input{Lectures/Lecture \arabic{lecture}.tex}
}
\end{document}